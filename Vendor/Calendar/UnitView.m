...
- (void) setProperty
{
    ...
    _scrollView.frame = CGRectMake(0, (self.bounds.size.height - defaultWidth)/2.0, self.bounds.size.width - 50, defaultWidth);
    ...
    _defaultUnit = [[UnitCell alloc] initWithFrame:CGRectMake(defaultPace, 0, defaultWidth, defaultWidth) andIcon:@"讨论组-添加" andName:@""];
