...
//        _dateLabel.backgroundColor =  [UIColor colorWithRed:27/255.0 green:161.0/255 blue:238/255.0 alpha:1];
 ...
 *  修改选中颜色
 *
 *  @param blnSelected <#blnSelected description#>
 */
...
#pragma mark  -------------修改颜色的地方
        self.dateLabelContainer.backgroundColor = (blnSelected)?[UIColor colorWithHex:0xffc700]: [UIColor colorWithHex:0xffc700];
        //0081c1

        
        self.dateLabel.textColor = (blnSelected)?[UIColor colorWithHex:0x0081c1]:[UIColor whiteColor];
    }else{
//        UIColor * color = [UIColor colorWithHex:0x1ba1ee];
//        UIColor * color = [UIColor colorWithRed:254/255.0 green:198/255.0 blue:46/255.0 alpha:1];
        
        self.dateLabelContainer.backgroundColor = (blnSelected)?[UIColor greenColor]: [UIColor colorWithHex:0x1ba1ee];
        //1ba1ee
        self.dateLabel.textColor =[UIColor whiteColor];
        //(blnSelected)?[UIColor colorWithRed:52.0/255.0 green:161.0/255.0 blue:255.0/255.0 alpha:1.0]:[self colorByDate];
    }
