...
-(UIView *)dailySubViewContainer{
    if(!_dailySubViewContainer){
        _dailySubViewContainer = [[UIImageView alloc] initWithFrame:CGRectMake(0, 11, self.bounds.size.width, DATE_VIEW_HEIGHT)];
...
//        [_backgroundImageView addSubview:self.dailyInfoSubViewContainer];
    ...
    //self.backgroundImageColor? self.backgroundImageColor : [UIColor colorWithPatternImage:[UIImage calendarBackgroundImage:self.bounds.size.height]];;
...
//    dayTitleLabel.backgroundColor = [UIColor redColor];
//    dayTitleLabel.layer.cornerRadius = dayTitleLabel.frame.size.width/2;
//    dayTitleLabel.clipsToBounds = YES;
